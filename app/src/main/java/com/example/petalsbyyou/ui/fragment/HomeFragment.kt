...
class HomeFragment : Fragment(), ProductAdapter.ProductClickListener {
    ...
    private fun loadProducts() {
        ...
        val products = arrayListOf(
            ...
            ProductModel("4", "Sunflower Bunch", "Adoration, loyalty, longevity", 19.99, R.drawable.sunflowers),
            ProductModel("5", "Lily Bouquet", "Purity, innocence, virtue", 34.99, R.drawable.lily),
            ProductModel("6", "Forget-Me-Not Set", "Remembrance, true love, loyalty", 27.99, R.drawable.forget_me_not),
            ProductModel("7", "Chrysanthemum Elegance", "Loyalty, friendship, abundance", 32.99, R.drawable.chrysanthemum),
            ProductModel("8", "Lavender Bliss", "Serenity, calmness, devotion", 22.99, R.drawable.lavenders),
            ProductModel("9", "Peony Romance", "Prosperity, good fortune, romance", 42.99, R.drawable.peony),
            ProductModel("10", "Daisy Freshness", "Happiness, innocence, simplicity", 18.99, R.drawable.daisy)
        )
